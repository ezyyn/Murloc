...
namespace Murloc {
	...
	void GraphicsPipeline::Invalidate(VkRenderPass renderPass, const Ref<Shader>& shader)
	{
		...
		vertShaderStageInfo.module = shader->GetShaderModules()[ShaderType::VERTEX];
		vertShaderStageInfo.pName = "main";
		//Fragment 
		VkPipelineShaderStageCreateInfo fragShaderStageInfo{};
		fragShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
		fragShaderStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
		fragShaderStageInfo.module = shader->GetShaderModules()[ShaderType::FRAGMENT];
		...
		auto& bufferLayout = shader->GetBufferLayout();
		...
		MUR_VK_ASSERT(vkCreatePipelineLayout(VulkanContext::GetLogicalDevice()->GetNative(), &pipelineLayoutInfo, nullptr, &m_PipelineLayout));
		...
		MUR_VK_ASSERT(vkCreateGraphicsPipelines(VulkanContext::GetLogicalDevice()->GetNative(), 
			VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &m_NativePipeline));
	}
