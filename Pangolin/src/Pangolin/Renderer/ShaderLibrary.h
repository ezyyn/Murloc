...
namespace PG
{
	struct ShaderData
	{
		...
		std::unordered_map<ShaderStage, std::vector<uint32_t>> CompiledSources;
	...
	private:
		...
		void Reflect(ShaderStage type, const std::vector<uint32_t> compiled, const std::string& filepath);
